    ...
    return (
        <View id='footer-wrap'>
            <footer>
                ...
                <p>
                    <a href='/cookiepolicy'>{t("policy_cookie")}</a>-
                    <a href='/legalterms'>{t("legal_terms")}</a>-
                    <a href='/privacypolicy'>{t("policy_privacy")}</a>
                </p>
                <p>
                    <a href='insta/envrac'>
                        <FontAwesomeIcon
                ...
                <p>
                    <span onClick={() => changeLanguageHandler("fr")}>FR</span>{" "}
                    |{" "}
